...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    $insert_user = "INSERT INTO `users`(`username`, `email`, `password`, `role`) VALUES ('$username','$email','$hashed_pass', 'admin')";
...
<body>
  ...
  <div class="flex items-center justify-center min-h-screen bg-background">
    <div class="bg-card shadow-lg rounded-lg p-8 max-w-md w-full">
      <h2 class="text-2xl font-bold text-primary text-center mb-6">Admin Register</h2>
